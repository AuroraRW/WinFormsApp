...
namespace LINQ3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //bool boolSE = employeeList.SequenceEqual(employeeListCompare);
            ...
            //List<Employee> employeeList2 = new List<Employee> { new Employee { Id = 5, FirstName = "Tom", LastName = "Stark" }, new Employee { Id = 6, FirstName = "Debbie", LastName = "Townsend" } };
            ...
            //    totAnnualSalary = e.AnnualSalary + totAnnualSalary;
            ...
            //var results = employeeList.Except(employeeList2);

            //foreach (var item in results)
            //    Console.WriteLine($"{item.Id,-5} {item.FirstName,-10} {item.LastName,-10}");

            ////Intersect
            //var results = employeeList.Intersect(employeeList2);

            //foreach (var item in results)
            //    Console.WriteLine($"{item.Id,-5} {item.FirstName,-10} {item.LastName,-10}");

            ////Union
            //var results = employeeList.Union(employeeList2);
